...
#define SUNXI_SPDIF_FREQ_MULTIPLIER
#define SUNXI_SPDIF_CLK_DIV0		7
#define SUNXI_SPDIF_CLK_DIV1		8
#define SUNXI_SPDIF_LOCK_STATE_DETECT
#else
#undef SUNXI_SPDIF_FREQ_MULTIPLIER
#undef SUNXI_SPDIF_CLK_DIV0
#undef SUNXI_SPDIF_CLK_DIV1
#undef SUNXI_SPDIF_LOCK_STATE_DETECT
#endif
...
struct sunxi_spdif_info {
	...
	struct delayed_work dw_detect_lock_state;
	int lock_state;
	int irq_num;
	spinlock_t lock;
