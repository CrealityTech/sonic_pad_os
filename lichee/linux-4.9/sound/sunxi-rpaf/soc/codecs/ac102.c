...
static struct i2c_client *i2c_ctrl[AC102_CHIP_NUMS];
int	regulator_en;
...
static int ac102_set_sysclk(struct snd_soc_dai *dai, int clk_id,
...
static int ac102_set_pll(struct snd_soc_dai *dai, int pll_id, int source,
