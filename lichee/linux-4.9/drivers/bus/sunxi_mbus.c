...
static SENSOR_DEVICE_ATTR(pmu_ce_ddr, 0400,
			  mbus_show_value, NULL, MBUS_PMU_CE);
static SENSOR_DEVICE_ATTR(pmu_dsp_ddr, 0400,
			  mbus_show_value, NULL, MBUS_PMU_DSP);
static SENSOR_DEVICE_ATTR(pmu_ndfc_ddr, 0400,
			  mbus_show_value, NULL, MBUS_PMU_NDFC0);
static SENSOR_DEVICE_ATTR(pmu_r_dma_ddr, 0400,
			  mbus_show_value, NULL, MBUS_PMU_R_DMA);
static SENSOR_DEVICE_ATTR(pmu_aipu_ddr, 0400,
			  mbus_show_value, NULL, MBUS_PMU_AIPU);
static SENSOR_DEVICE_ATTR(pmu_totddr, 0400,
			  mbus_show_value, NULL, MBUS_PMU_TOTAL);
#else
...
static struct attribute *mbus_attributes[] = {
	...
	&sensor_dev_attr_pmu_dma_ddr.dev_attr.attr,
	&sensor_dev_attr_pmu_ce_ddr.dev_attr.attr,
	&sensor_dev_attr_pmu_dsp_ddr.dev_attr.attr,
	&sensor_dev_attr_pmu_ndfc_ddr.dev_attr.attr,
	&sensor_dev_attr_pmu_r_dma_ddr.dev_attr.attr,
	&sensor_dev_attr_pmu_aipu_ddr.dev_attr.attr,
	&sensor_dev_attr_pmu_totddr.dev_attr.attr,
#else
	&sensor_dev_attr_pmu_gpuddr.dev_attr.attr,
	&sensor_dev_attr_pmu_ve_ddr.dev_attr.attr,
