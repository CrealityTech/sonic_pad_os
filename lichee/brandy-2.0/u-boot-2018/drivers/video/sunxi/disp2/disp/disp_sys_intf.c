...
/*
*******************************************************************************
*                     get_set_lcd_param_index_from_flash
*
* Description:
...
*******************************************************************************
*/
int get_set_lcd_param_index_from_flash(bool is_set, int idx)
{
	char *argv[6];
	char part_num[16] = {0};
	char len[16] = {0};
...
int disp_update_lcd_param(int lcd_param_index)
{
	...
	*/
		...
		flash_idx = get_set_lcd_param_index_from_flash(false, flash_idx);
		if (flash_idx == -1) {
			get_set_lcd_param_index_from_flash(true, pre_index);
			flash_idx = get_set_lcd_param_index_from_flash(false, flash_idx);
		}
