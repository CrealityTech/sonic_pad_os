...
ifeq ($(ARCH),openrisc)
comp-cflags$(sm) =  -nostdlib -Wl,--gc-sections -static  -DSUB_VER=\"$(VER)\"
endif

ifeq ($(ARCH),d10)
comp-cflags$(sm) = -DCONFIG_NO_NDS32_EXT_EX9  -DCFG_LLINIT \
			-Os -nostartfiles -static -mcmodel=medium \
			-nostdlib  -Wall -Werror -Wl,--gc-sections -mvh -DSUB_VER=\"$(VER)\"
endif
comp-aflags$(sm) =
comp-cppflags$(sm) =
