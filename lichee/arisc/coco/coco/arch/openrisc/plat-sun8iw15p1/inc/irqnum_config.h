...
#define INTC_R_USB0_IRQ		40
#define INTC_R_USB1_IRQ		41
...
static u32 irq_table[17][2] =
{
	...
	{26, 127},		//r_twi0
	{31, 128},		//r_rsb
	{40, 86},		//usb0  usb2.0_drd_ehci  usb2.0_drd_ohci
	{40, 87},		//usb0  usb2.0_drd_ehci  usb2.0_drd_ohci
	{41, 88},		//usb1  usb2.0_host1_ehci usb2.0_host1_ohci
	{41, 89},		//usb1  usb2.0_host1_ehci usb2.0_host1_ohci
};
...
static inline s32 CPUS_IRQ_MAPTO_CPUX(u32 intno)
{
	...
	for(cpus_irq = 0; cpus_irq< 17;cpus_irq++) {
...
{
	u32 cpux_irq;
	for(cpux_irq = 0; cpux_irq< 17;cpux_irq++) {
		if(irq_table[cpux_irq][1] == intno)
