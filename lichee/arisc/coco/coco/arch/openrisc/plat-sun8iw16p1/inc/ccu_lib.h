...
#define GET_CCU_FACTOR_M_MASK(x)	\
				(x >= R_PRCM_REG_BASE) ?  (unsigned int)(GET_PRCM_FACTOR_M_MASK(x)):(unsigned int) CCMU_FACTOR_M_MASK
...
#define CCU_CPU_SRC_MASK		0x7
#define	 PERIO_1X_PARA		2
...
#define	GET_BUS_TYPE(x)	x = PLL_PERI0_CTRL_REG ? BUS_TYPE_PLL : BUS_TYPE_AHB_PSI_APB
