...
extern int or32_libc;
extern int or32_redzone;
extern int pedantic;
...
#define MASK_SCHED_LOGUE (1 << 5)
#define MASK_PADSTRUCT (1 << 6)
#define MASK_MASK_ROR (1 << 7)
#define MASK_MASK_SEXT (1 << 8)
...
#define TARGET_SCHED_LOGUE ((target_flags & MASK_SCHED_LOGUE) != 0)
...
enum opt_code
{
  ...
  OPT_mglibc,                                /* -mglibc */
  OPT_mhard_div,                             /* -mhard-div */
  OPT_mhard_float,                           /* -mhard-float */
  OPT_mhard_mul,                             /* -mhard-mul */
  OPT_mlogue,                                /* -mlogue */
  OPT_mnewlib,                               /* -mnewlib */
  OPT_mpadstruct,                            /* -mpadstruct */
  OPT_mredzone_,                             /* -mredzone= */
  OPT_mror,                                  /* -mror */
  OPT_msext,                                 /* -msext */
  OPT_msoft_div,                             /* -msoft-div */
  OPT_msoft_float,                           /* -msoft-float */
  OPT_msoft_mul,                             /* -msoft-mul */
  OPT_muclibc,                               /* -muclibc */
  OPT_nocpp,                                 /* -nocpp */
