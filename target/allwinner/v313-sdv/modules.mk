...
define KernelPackage/vin-v4l2
  ...
  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vin/modules/sensor/s5k3h5xa.ko
  ...
  AUTOLOAD:=$(call AutoProbe,videobuf2-core videobuf2-dma-contig videobuf2-memops videobuf2-v4l2 vin_io s5k3h5xa vin_v4l2 hdmi20)
endef
