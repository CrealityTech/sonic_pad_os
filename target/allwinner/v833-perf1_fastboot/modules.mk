...
define KernelPackage/sunxi-sound
  ...
  TITLE:=sun8iw19 sound support

  FILES:=$(LINUX_DIR)/sound/soc/sunxi/sun8iw19-sndcodec.ko
  FILES+=$(LINUX_DIR)/sound/soc/sunxi/sun8iw19-snddaudio.ko
  FILES+=$(LINUX_DIR)/sound/soc/sunxi/sun8iw19-codec.ko
  FILES+=$(LINUX_DIR)/sound/soc/sunxi/snd-soc-sunxi-daudio.ko
  FILES+=$(LINUX_DIR)/sound/soc/sunxi/snd-soc-sunxi.ko
  AUTOLOAD:=$(call AutoProbe,snd-soc-sunxi sun8iw19-sndcodec sun8iw19-codec sun8iw19-snddaudio snd-soc-sunxi-daudio)
endef

define KernelPackage/sunxi-sound/description
 Kernel modules for sun8iw19-sound support
endef
...
define KernelPackage/regmap-mmio
  SUBMENU:=$(OTHER_MENU)
  TITLE:=regmap-mmio support
  FILES:=$(LINUX_DIR)/drivers/base/regmap/regmap-mmio.ko
  AUTOLOAD:=$(call AutoProbe,regmap-mmio)
endef

define KernelPackage/regmap-mmio/description
 Kernel modules for regmap-mmio support
endef
