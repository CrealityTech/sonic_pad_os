...
define KernelPackage/sunxi-sound
  ...
  TITLE:=sun8iw5 sound support
  FILES+=$(LINUX_DIR)/sound/soc/sunxi/audiocodec/sunxi_codec.ko
  FILES+=$(LINUX_DIR)/sound/soc/sunxi/audiocodec/sunxi_codecdma.ko
  FILES:=$(LINUX_DIR)/sound/soc/sunxi/audiocodec/sun8iw5_machine.ko
  FILES+=$(LINUX_DIR)/sound/soc/sunxi/audiocodec/sun8iw5_sndcodec.ko
  AUTOLOAD:=$(call AutoLoad,30,sunxi_codecdma sunxi_codec sun8iw5_sndcodec sun8iw5_machine)
endef

define KernelPackage/sunxi-sound/description
  Kernel modules for sun8iw5-sound support
endef
