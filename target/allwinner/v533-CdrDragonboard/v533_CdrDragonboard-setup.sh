...
function mkapp
{
    ...
    make package/allwinner/eyesee-mpp/V533CdrDragonboard/compile $@
    make package/install $@
    cd ${curDir}
}
...
function cleanapp
{
    local curDir=$(pwd)
    croot
    make package/allwinner/eyesee-mpp/V533CdrDragonboard/clean $@
...
{ 
    croot;
    cd external/eyesee-mpp/middleware/sun8iw19p1
}

capp_p () 
{ 
    croot;
    cd package/allwinner/eyesee-mpp/V533CdrDragonboard
}
capp_s () 
{ 
    croot;
    cd external/eyesee-mpp/V533CdrDragonboard/apps/DragonBoard
}
