...
define KernelPackage/sunxi-vfe
  ...
  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vfe/device/hm2131.ko
  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vfe/vfe_v4l2.ko
  KCONFIG:=\
    CONFIG_VIDEO_SUNXI_VFE \
    CONFIG_CSI_VFE
  AUTOLOAD:=$(call AutoLoad,90,videobuf2-core videobuf2-memops videobuf2-dma-contig videobuf2-v4l2 vfe_io hm2131 vfe_v4l2)
endef
