...
define KernelPackage/vin-v4l2
  ...
  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vin/modules/sensor/imx258_mipi.ko
  ...
  AUTOLOAD:=$(call AutoProbe,videobuf2-core videobuf2-dma-contig videobuf2-memops videobuf2-v4l2 vin_io imx258_mipi vin_v4l2 hdmi20)
endef
...
define KernelPackage/touchscreen-it7257_ts
  SUBMENU:=$(INPUT_MODULES_MENU)
  TITLE:= it7257_ts I2C touchscreen
  DEPENDS:= +kmod-input-core
  KCONFIG:= CONFIG_INPUT_TOUCHSCREEN \
	  CONFIG_TOUCHSCREEN_PROPERTIES \
	CONFIG_TOUCHSCREEN_IT7257_TS
  FILES:=$(LINUX_DIR)/drivers/input/touchscreen/it7257_ts.ko
  FILES+=$(LINUX_DIR)/drivers/input/touchscreen/of_touchscreen.ko
  AUTOLOAD:=$(call AutoProbe,of_touchscreen it7257_ts)
endef

define KernelPackage/touchscreen-it7257_ts/description
 Enable support for Focaltech 7257 touchscreen port.
endef

$(eval $(call KernelPackage,touchscreen-it7257_ts))
