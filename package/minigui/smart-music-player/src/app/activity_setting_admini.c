...
static void my_notify_proc(HWND hwnd, LINT id, int nc, DWORD add_data) {
    ...
    if (nc == STN_CLICKED) {
        ...
        case 9:
            ...
            break;
        default:
            sm_error("Did not do anything %ld\n", id);
            break;
        }
    }
}

static LRESULT ActivitySettingAdminiProc(HWND hWnd, UINT nMessage,
