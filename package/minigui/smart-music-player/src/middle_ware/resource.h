...
#define MUSIC_LIST_DIR      "/usr/res/sound"

#define ICON_PATH_SIZE  64
#define ICON_TOTAL_CNT  12
#define MUSIC_LIST_VIEW_SIZE 32
...
#define CFG_BACKGROUND_BMP                  "background"
...
typedef enum {
    ...
    MSG_PLAYBACK_COMPLETE,
    MSG_MUSIC_PLAY_ANIMATION_STOP,
    MSG_MUSIC_PLAY_ANIMATION_START,
    MSG_ACTIVITY_MUSIC_LIST_CLOSE,
} UserMsgType;

enum TimerID {
    ID_TIMER_UPDATE_TIME = 200,
    ID_TIMER_MUSIC_PLAYING_ANIMATION,
    ID_TIMER_PROGRESS_UPDATE,
    ID_TIMER_SWITCH_BUTTON,
    ID_TIMER_LIST_SLIDE,
    ID_TIMER_MUSIC_TIME_UPDATE,
    ID_TIMER_MUSIC_SPECTRUM,
};
...
BOOL isActivityMusicListOpen;

#define PCM_DATA_SIZE 128

unsigned char g_AudioPcmData[PCM_DATA_SIZE];
pthread_mutex_t spectrumMutex;
BOOL isActivityMusicSpectrumOpen;
BOOL isAudioPcmDataCopy;
