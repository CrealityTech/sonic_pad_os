...
void setCurrentIconValue(enum ResourceID resID, int cur_val) {
    ...
    case ID_SELECT_BUTTON_BMP:
        ...
        break;
    case ID_BACKGROUND_BMP:
        resData->backgroundIcon.current = cur_val;
        break;
    default:
...
int getCurrentIconFileName(enum ResourceID resID, char *file) {
    ...
    case ID_SELECT_BUTTON_BMP:
        ...
        break;
    case ID_BACKGROUND_BMP:
        CHECK_CURRENT_ICON_VALID(resData->backgroundIcon);
        current = resData->backgroundIcon.current;
        memcpy((void *) file,
                (void *) resData->backgroundIcon.iconName[current],
                ICON_PATH_SIZE);
        break;
    default:
...
int initFastMenuResource(void) {
    ...
    configTable2 configTableIcon[] =
            ...
            CFG_HEADBAR_BUTTON_BMP_AREA, (void*) &resData->headbarButtonIcon },
                    ...
                    {
                    CFG_BACKGROUND_BMP, (void*) &resData->backgroundIcon }, };
