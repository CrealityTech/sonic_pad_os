...
static const struct fmt_capture {
        ...
        {       begin_wave,     end_wave,       "WAVE",             8589934592LL },
};
...
static bool lpsd_status_is_idle(void)
{
	...
	if (file_read("/sys/devices/platform/soc/mad/sunxi_mad_audio/lpsd_status",
		buf, &len) != 0)
		return true;
...
static void mad_standby(void)
{
	...
	/*file_write("/sys/module/printk/parameters/console_suspend", "N");*/
