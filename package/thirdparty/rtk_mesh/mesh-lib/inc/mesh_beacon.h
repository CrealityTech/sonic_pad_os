...
extern uint32_t intensive_adv_retrans_count;
extern uint32_t intensive_adv_retrans_interval;
extern bool intensive_adv_enable;
extern uint16_t intensive_adv_scan_window; //uints 0.625ms
extern uint16_t intensive_adv_scan_interval; //uints 0.625ms
extern uint32_t wait_to_send_adv_interval;
#endif
