...
#define MESH_CONFIGURATION_MODEL_USE_APP_KEY    0 //!< violate the spec to use app key, shall also set mesh_node.features.cfg_model_use_app_key.
...
#include "data_uart.h"
#else
#define data_uart_debug(fmt, ...)
#define data_uart_dump(pbuffer,len)
#define data_uart_send_string(data,len)
#endif
...
#define MESH_SCHED_ADV_PKT_NUM                  30 //!< The number of stored mesh advertise packets
...
#define MESH_PB_ADV_RETRY_PERIOD                100 //!< ms
...
#define BAIDU_CUBE_PROJ
#ifdef BAIDU_CUBE_PROJ
#define BAIDU_TRANSPORT_SEGMENT_ACK_LIMITED
#define BAIDU_RETRANS_SEGMENT_MSG_LIMITED
#define BAIDU_LESS_SEGMENT_ACK
#define BAIDU_PB_ADV_PARAM_ADJUST
#define HEARTBEAT_FOR_BAIDU
#define BT_4_2
#define INTENSIVE_ADV_ENABLE_P0
#endif
