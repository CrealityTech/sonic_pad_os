...
#ifdef HEARTBEAT_FOR_BAIDU

extern uint32_t ali_hb_pub_period;
extern uint32_t ali_hb_monitor_timeout;

void hb_record_init(void);
int calendar_timer_create(void );
void calendar_handle_timeout(void );
