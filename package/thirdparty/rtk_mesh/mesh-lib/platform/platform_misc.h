...
/** @addtogroup Mesh_Platform_Misc Mesh Platform Miscellaneous
  * @brief Miscellaneous
  * @{
  */

/** @defgroup Mesh_Platform_Misc_Exported_Functions Mesh Platform Misc Exported Functions
  * @brief
  * @{
  */
...
uint16_t plt_bin_to_hex(char *phex, uint8_t *pbin, uint16_t phex_len);

/** @brief reset */
#define plt_reset(reason)

/** @} */

/** @} End of group Mesh_Platform_Misc */
