...
#define GAP_SCHED_ADV_INTERVAL_MIN              0x10 /* 10ms */
#define GAP_SCHED_ADV_INTERVAL_MAX              0x10 /* 10ms */
#else
...
#define GAP_SCHED_SCAN_INTERVAL                 0x30 /* 30ms */
#define GAP_SCHED_SCAN_WINDOW                   0x20 /* 20ms */
...
typedef enum
{
    ...
    GAP_SCHED_RUN_TYPE_TIMEOUT,
		...
		GAP_SCHED_RUN_TYPE_WAIT_TO_SEND_ADV_TIMEOUT
#endif
...
#ifdef INTENSIVE_ADV_ENABLE_P0
	bool is_intensive_adv;
#endif
#ifdef BAIDU_RETRANS_SEGMENT_MSG_LIMITED
	bool is_segment_msg;
#endif
...
void gap_sched_retrans_count_clear(uint32_t access_opcode);

void gap_shced_retrans_count_clear_check(void );

#ifdef INTENSIVE_ADV_ENABLE_P0
void gap_handle_wait_to_send_adv_timeout(void);
#endif
