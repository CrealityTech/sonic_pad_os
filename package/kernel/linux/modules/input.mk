...
define KernelPackage/touchscreen-tlsc6x
  SUBMENU:=$(INPUT_MODULES_MENU)
  TITLE:=tlsc6x support
  DEPENDS:= +kmod-input-core
  KCONFIG:= \
	CONFIG_INPUT_TOUCHSCREEN \
	CONFIG_TOUCHSCREEN_TLSC6X
  FILES:=$(LINUX_DIR)/drivers/input/touchscreen/tlsc6x/tlsc6x.ko
  AUTOLOAD:=$(call AutoProbe,tlsc6x)
endef

define KernelPackage/touchscreen-tlsc6x/description
 Enable support for tlsc6x touchscreen port.
endef

$(eval $(call KernelPackage,touchscreen-tlsc6x))
